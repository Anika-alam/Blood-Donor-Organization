...
echo "<tr><th>Name</th><th>Location</th><th>Contact</th><th>Blood_group</th><th>Last_date_of_donation</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT name,location,contact,blood_group,last_date_of_donation FROM user"); 
    $stmt->execute();

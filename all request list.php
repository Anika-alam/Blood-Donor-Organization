...
<body>
	...
	<div class="banner-bottom">
		<div class="container">
				...
				<form action="all request list search.php" method="POST">
	   <input type="text" id="search" name="search" placeholder="search for requester"/>
	   <input type="submit" value="serach"/>
	</form>   
				<h3 class="tittle three">ALL REQUEST</h3>
				<?php
echo "<table style='border: solid 5px black;'>";
echo "<tr><th>Name</th><th>Location</th><th>Contact</th><th>Blood_group</th><th>Blood_amount</th><th>Delivary Date</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT r_name,r_location,r_contact,r_blood_group,r_blood_amount,r_delivary_date FROM request"); 
    $stmt->execute();

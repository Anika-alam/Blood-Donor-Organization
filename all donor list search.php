...
<body>
	...
	<div class="banner-bottom">
	   ...
	   <input type="submit" value="serach"/>
				...
				<h3 class="tittle three">ALL DONOR LIST </h3>
...
if(isset($_POST['search'])){
    ...
    $query = mysqli_query($connection,"SELECT * FROM user WHERE name LIKE '%$searchkey%' OR location LIKE '%$searchkey%'") or die("Could not search!");
    ...
    if($count == 0){
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            $output .='<div>'.$name.'<div>' .$location.' '.$blood_group.'</div>';
